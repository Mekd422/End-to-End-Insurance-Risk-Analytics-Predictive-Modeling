...
- Computed summary statistics and distributions of `TotalPremium`, `TotalClaims`, and `loss ratios`  
- Identified outliers and skewed distributions  
- Analyzed geographic, vehicle, and client-level trends  
...
- SHAP analysis included for feature importance  
